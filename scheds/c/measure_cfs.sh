...
main() {
    ...
    # ログファイルのコピーを取る
    mkdir -p "/home/hirata/logs/cfs-versus-scx/cfs"
    cp "$OUTPUT_FILE1" "/home/hirata/logs/cfs-versus-scx/cfs/$OUTPUT_FILE1"
    cp "$OUTPUT_FILE2" "/home/hirata/logs/cfs-versus-scx/cfs/$OUTPUT_FILE2"
