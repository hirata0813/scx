...
#include "scx_supersimple.bpf.skel.h"
...
int main(int argc, char **argv)
{
	...
	unlink("/sys/fs/bpf/supersimple_ops"); // エラー無視でOK
	...
	skel = SCX_OPS_OPEN(supersimple_ops, scx_supersimple);
